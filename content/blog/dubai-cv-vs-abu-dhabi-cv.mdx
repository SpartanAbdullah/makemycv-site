...
**Professional photo.** Photos are common on CVs across the UAE, but the expectation is stronger in Abu Dhabi — particularly for government and semi-government roles where a professional headshot is commonly included. For Dubai private-sector roles it's increasingly optional. Include one if you have a clean, professional shot — and follow the posting either way.
