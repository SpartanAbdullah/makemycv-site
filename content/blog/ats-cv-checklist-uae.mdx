...
**What to do:** Strip all of it. Use plain text for skills. Keep dividers as simple horizontal lines. A photo floated inside the text column breaks parsing — if you want one, use a template with a dedicated header slot outside the text flow (our [photo guide](/blog/should-cv-have-photo-uae) has the sector-by-sector answer), or leave it off.
...
Not sure how you score? Upload your PDF to the free [ATS resume checker](/resume-checker) — 60+ UAE-tuned checks, including everything on this list, in about 30 seconds. And if your bullets are the weak point, see the [weak-vs-strong CV examples by sector](/cv-examples-uae).
